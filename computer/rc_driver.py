...
class VideoStreamHandler(socketserver.StreamRequestHandler):
    ...
    #nn.load_model("saved_model/nn_model 2 72.3 - 72.2.xml")
    #nn.load_model("saved_model/nn_model 2 70.7 - 70.3.xml")
    #nn.load_model("saved_model/nn_model 1 70.4 - 61.8.xml")
    nn.load_model("saved_model/nn_model 3 70.8 - 68.2.xml")
...
if __name__ == '__main__':
    #h, p1, p2 = "192.168.1.57", 8001, 8002
    h, p1, p2 = "192.168.152.78", 8001, 8002
