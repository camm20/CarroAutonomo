...
class CollectTrainingData(object):
    ...
    def __init__(self, host, port, input_size):
        ...
        self.socketMotor = socket.socket()
        self.socketMotor.connect(('192.168.1.59', 2020))
                    ...
                    for event in pygame.event.get():
                        if event.type == KEYDOWN:
                            ...
                            if key_input[pygame.K_UP] and key_input[pygame.K_RIGHT]:
                                ...
                                self.socketMotor.send(b'Top-Right')
                                ...
                                self.socketMotor.send(b'Top-Left')

                            elif key_input[pygame.K_DOWN] and key_input[pygame.K_RIGHT]:
                                print("Reverse Right")
                                #self.ser.write(chr(8).encode())
                                self.socketMotor.send(b'Back-Right')

                            elif key_input[pygame.K_DOWN] and key_input[pygame.K_LEFT]:
                                print("Reverse Left")
                                #self.ser.write(chr(9).encode())
                                self.socketMotor.send(b'Back-Left')
                            ...
                            # simple orders
                                ...
                                self.socketMotor.send(b'Top')

                            elif key_input[pygame.K_DOWN]:
                                print("Reverse")
                                #self.ser.write(chr(2).encode())
                                self.socketMotor.send(b'Back')
                                ...
                                self.socketMotor.send(b'Left')

                            elif key_input[pygame.K_x] or key_input[pygame.K_q]:
                                print("exit")
                                self.send_inst = False
                                #self.ser.write(chr(0).encode())
                                self.socketMotor.send(b'Exit')
                                #self.ser.close()
                                break

                        elif event.type == pygame.KEYUP:
                            #self.ser.write(chr(0).encode())
                            self.socketMotor.send(b'Stop')
